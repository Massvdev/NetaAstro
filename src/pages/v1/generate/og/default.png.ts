...
export const GET: APIRoute = async () => {
  ...
  <div style="background-color: #0f0f0f; display: flex; flex-direction: column; height: 100%; padding: 3rem; width: 100%">
    <div style="display:flex; height: 100%; width: 100%; background-color: #111827; border: 6px solid purple; border-radius: 0.5rem; padding: 2rem; filter: drop-shadow(6px 6px 0 rgb(0 0 0 / 1));">
